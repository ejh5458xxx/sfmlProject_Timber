# sfmlProject_Timber
A cross-platform [SFML](https://www.sfml-dev.org) 2.5.1 & C++17 build environment for [Visual Studio Code](https://code.visualstudio.com/).  Attempt to code a 2D game (called Timber based on the actual Timber game - see on Slice) using C++ and sfml.
